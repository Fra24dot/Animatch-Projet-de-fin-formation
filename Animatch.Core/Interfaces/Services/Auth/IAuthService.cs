...
namespace Animatch.Core.Interfaces.Services.Auth
{
    public interface IAuthService
    {
        ...
        Task<Shelter> RegisterShelterAsync(string name, string email, string password, string companyNumber, string phoneNumber, string address, string city, string postalCode, int creationYear);
    }
}
